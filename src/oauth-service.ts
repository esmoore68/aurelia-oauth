...
export interface OAuthConfig {
  ...
  applicationUsesPushState?: boolean;
}
...
export class OAuthService {
  ...
  constructor(
    ...
    this.defaults = {
      ...
      applicationUsesPushState: false
    };
  }
  ...
  private getBaseRouteUrl = (): string => {
    return this.config.applicationUsesPushState ? window.location.href.split('#')[0] + '#' : window.location.origin + '/#/';
  }
